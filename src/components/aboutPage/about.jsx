...
function About() {
    ...
    const isSuperAdmin = getCurrentUser()
    ...
    return (
        <div className="aboutWrap">
            ...
            <p>
                ...
                problems. This programming club is first formed during 2015-2016
                academic year. <br /> <br />
                ICE programming club is organizing Intra-department programming
                contest periodically and members of the ICE programming club are
                trying to enter teams into national wide programming
                competitions. <br /> <br />
                The key objective of this ICE programming club are the
                following: <br />
                <br />
            </p>
            <ul>
                ...
                <li>
                    ...
                    sorting algorithms, arithmetic, algebra, graph algorithms,
                    and number theory
                </li>
                <li>Enhance your career prospects</li>
                <li>
                    Start a potential research project which may lead to
            ...
            <p>
                The club is open to all ICE students including undergraduate and
                post graduate students. The only requirement is a keen interest
            ...
            <p>
                In general, meetings are held weekly on alternating days, and
                focus on programming problem study, project collaboration, and
                student networking.
            </p>
            <div>
                ...
                <p>
                    ...
                    {info && (
                        <Link
                            to={
                                "/profiles/" +
                                info.studentCommittee.generalSecretary.profileId
                            }
                        >
                ...
                <p>
                    ...
                    {info && (
                        <Link
                            to={
                                "/profiles/" +
                                info.studentCommittee.assistantGeneralSecretary
                                    .profileId
                            }
                        >
                            {
                ...
                <p>
                    ...
                    {info && (
                        <Link
                            to={
                                "/profiles/" +
                                info.studentCommittee.officeSecretary.profileId
                            }
                        >
                ...
                <p>
                    ...
                    {info && (
                        <Link
                            to={
                                "/profiles/" +
                                info.studentCommittee.assistantOfficeSecretary
                                    .profileId
                            }
                        >
                            {
                ...
                <p>
                    ...
                    {info && (
                        <Link
                            to={
                                "/profiles/" +
                                info.studentCommittee.financeSecretary.profileId
                            }
                        >
                ...
                <p>
                    ...
                    {info && (
                        <Link
                            to={
                                "/profiles/" +
                                info.studentCommittee.assistantFinanceSecretary
                                    .profileId
                            }
                        >
                            {
                ...
                <p>
                    ...
                    {info && (
                        <Link
                            to={
                                "/profiles/" +
                                info.studentCommittee.publicationSecretary
                                    .profileId
                            }
                        >
                ...
                <p>
                    ...
                    {info && (
                        <Link
                            to={
                                "/profiles/" +
                                info.studentCommittee
                                    .assistantPublicationSecretary.profileId
                            }
                        >
                            {
                                info.studentCommittee
                                    .assistantPublicationSecretary.name
                            }
                        </Link>
                    )}
                </p>
                <p>
                    ...
                    {info && (
                        <Link
                            to={
                                "/profiles/" +
                                info.studentCommittee.socialWelfareSecretary
                                    .profileId
                            }
                        >
                    ...
                    {info && (
                        <Link
                            to={
                                "/profiles/" +
                                info.studentCommittee
                                    .assistantSocialWelfareSecretary.profileId
                            }
                        >
                            {
                                info.studentCommittee
                                    .assistantSocialWelfareSecretary.name
                            }
                        </Link>
                    )}
                </p>
