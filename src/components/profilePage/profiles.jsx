...
function Profiles() {
    ...
    const handleProPicChange = async (e) => {
        ...
        if (file && file.type.substring(0, 5) === "image") {
            ...
            setFile(null);
            toast.error("Wrong file format. Please select an image file.");
        }
    };
        ...
        return contests.map((contest) => {
            return (
                <div key={contest._id}>
                    ...
                    >
                        <p className="contestHeading col-md-3">
                            {contest.header}
                        </p>
                    ...
                    {contest.show && (
                        <div className="row contestCard">
                            <div className="col-lg-4 contestCardPicDiv">
                                ...
                                >
                                    <img
                                        src={getImgUrl(contest.imgLink[0])}
                                        alt=""
                                    />
                                </div>
                                <div
                                ...
                                >
                                    <img
                                        src={getImgUrl(contest.imgLink[1])}
                                        alt=""
                                    />
                                </div>
                                <div
                                ...
                                >
                                    <img
                                        src={getImgUrl(contest.imgLink[2])}
                                        alt=""
                                    />
                                </div>
                                <div
                                ...
                                >
                                    <img
                                        src={getImgUrl(contest.imgLink[3])}
                                        alt=""
                                    />
                                </div>
                            </div>
                            ...
                            <div className="col-lg contestCardDesDiv">
                                ...
                                <a
                                    href={`//${getExternalUrl(contest.link)}`}
                                    target="_blank"
                                    rel="noreferrer"
                                >
                                    Standings
        ...
        <div className="profileWrap">
            <div className="row picAndBioSection">
                    ...
                    {ownProfile && (
                        <>
                            <button
                                ...
                                onClick={() =>
                                    setShowUpdateImgBtn(!showUpdateImgBtn)
                                }
                            >
                                Update Picture
                            </button>
                ...
                <div className="col-lg bioAndContactSec">
                    ...
                    <h4>Contacts</h4>
                    <p>
                        <span>Phone :</span> +880{profileInfo.contacts.phone}{" "}
                        <br />
                        <span>Email :</span>{" "}
