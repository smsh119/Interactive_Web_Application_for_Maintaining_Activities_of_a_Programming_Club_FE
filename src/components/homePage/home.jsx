            ...
            <div className="row gx-4">
                <div className="col-md-6 clubInto">
                    ...
                    <p>
                        ...
                        stimulating, cooperative environment where students can
                        interact and learn from each other by solving various
                        programming problems. This programming club is first
                        formed during 2015-2016 academic year. ICE programming
                        club is organizing Intra-department programming contest
                        periodically and members of the ICE programming club are
                        trying to enter teams into national wide programming
                        competitions. The key objective of this ICE programming
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            structures, sorting algorithms, arithmetic, algebra,
